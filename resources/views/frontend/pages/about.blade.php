        ...
        <section class="about about__style__two">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="bg-gray-100 p-4 pb-0 flex justify-center items-center rounded-sm">
                            <img src="{{ asset('' . $aboutpage->about_image) }}" alt="" class="w-96">
                        </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-9 col-lg-11">
                        <div class="testimonial__wrap">
                            ...
                            <div class="testimonial__two__active slick-initialized slick-slider">
                                ...
                                <div class="slick-list draggable">
                                    <div class="slick-track" style="opacity: 1; width: 1020px;">
                                        <div class="testimonial__item slick-slide slick-current slick-active"
                                            ...
                                            <div class="testimonial__content">
                                                <p>We are motivated by the satisfaction of our clients. Put your trust in us
                                                    &amp;share in our H.Spond Asset Management is made up of a team of
                                                    expert, committed and experienced people with a passion for financial
                                        ...
                                        <div class="testimonial__item slick-slide"
                            ...
                            <div class="testimonial__arrow"><button class="slick-prev slick-arrow" style=""><i
                                        class="far fa-long-arrow-left"></i></button><button class="slick-next slick-arrow"
                                    style=""><i class="far fa-long-arrow-right"></i></button></div>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="blog__post__thumb">
                                    <a href="{{ route('blog.details', $item->id) }}">
                                        <img src="{{ asset('' . $item->image) }}"
                                            class="w-[430px] h-[327px] overflow-hidden object-cover" alt="">
                                    </a>
