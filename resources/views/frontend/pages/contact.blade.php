    ...
    <div class="contact-area">
        <div class="container">
            <form action="#" class="contact__form">
                ...
                <button type="submit" class="bg-[#0054FF] uppercase font-bold p-3 text-white">send massage</button>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="flex items-center justify-center flex-col shadow-sm shadow-black  border p-14 hover:shadow-xl">
                    ...
                    <div class="col-lg-6">
                        <div class="homeContact__form">
                            <form action="#">
                                ...
                                <button class="  text-end uppercase font-bold p-1 text-black mt-1">Send Message</button>
