            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button"
                    ...
                    <img class="wd-30 ht-30 rounded-circle"
                        src="{{ Auth::user()->photo ? asset('upload/admin_images/' . Auth::user()->photo) : 'https://via.placeholder.com/30x30' }}"
                        alt="photo">
                </a>
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                            ...
                            src="{{ Auth::user()->photo ? asset('upload/admin_images/' . Auth::user()->photo) : 'https://via.placeholder.com/80x80' }}"
                            alt="photo">
                    ...
                    <ul class="list-unstyled p-1">
                        ...
                        <li class="dropdown-item py-2">
                            <a href="{{ route('admin.changepassword') }}" class="flex text-body ms-0 ">
                                <i class="me-2 icon-md" data-feather="edit"></i>
                                <span>Change password</span>
                            </a>
                        </li>
                        <li class="dropdown-item py-2">
                            <a href="javascript:;" class="flex text-body ms-0 ">
                                <i class="me-2 icon-md" data-feather="repeat"></i>
                                <span>Switch User</span>
                            </a>
                        </li>
                        <li class="dropdown-item py-2 ">
                            <a href="{{ route('admin.logout') }}" class="flex text-body ms-0 ">
